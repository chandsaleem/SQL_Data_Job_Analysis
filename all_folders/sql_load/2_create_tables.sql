...
ALTER TABLE public.company_dim OWNER to chandsaleem;
ALTER TABLE public.skills_dim OWNER to chandsaleem;
ALTER TABLE public.job_postings_fact OWNER to chandsaleem;
ALTER TABLE public.skills_job_dim OWNER to chandsaleem;
